...
/**
 * Elasticsearch document cho index {@code books}; không dùng chung với {@link Book} (JPA).
 */
@Getter
@Setter
@NoArgsConstructor
...
public class BookDocument {
    ...
    // When call repository.save(), you must call this function so that save book into ES
